...
function renderImport() {
  return `
    <div class="page">
      ...
      <div class="form-card">
        <h2 class="section-title" style="margin-bottom:8px">Export to Phone</h2>
        <p class="code-hint">Download all your transactions, budgets, and weekly plan — then import the file into the mobile app.</p>
